...
//3.Отрисовка названия программы (пути к ней)
//4.Основная часть (у каждого своя, но метод один - для унификации отрисовки всех стратегий) - для мониторинга это, например, отрисовка графика
//5.Итог
